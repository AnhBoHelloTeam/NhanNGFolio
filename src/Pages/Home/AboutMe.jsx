export default function AboutMe() {
  return (
    <section id="AboutMe" className="about--section">
      <div className="about--section--img animate-fade-in">
        <img
          src="./img/lumcay.jpg"
          alt="Nguyễn Thành Nhân - Full Stack Developer"
        />
      </div>
      <div className="hero--section--content--box about--section--box animate-slide-up">
        <div className="hero--section--content">
          <p className="section--title">About Me</p>
          <h2 className="section--heading">Hi, I'm Nguyễn Thành Nhân</h2>
          ...
          <p className="hero--section-description">
            I'm actively seeking internship and job opportunities in Da Nang to grow as a fullstack developer and contribute to meaningful projects. If you're looking for a dedicated, tech-savvy team member, I'd love to connect! Reach out at <a href="mailto:nhanng.thdhk4@gmail.com" style={{ color: '#6366f1', textDecoration: 'none', fontWeight: '600' }}>nhanng.thdhk4@gmail.com</a> or explore my portfolio and CV to learn more about my work. Let's build something amazing together!
          </p>
        </div>
      </div>
    </section>
